...
export default function Search() {
  ...
  return (
    <div className="flex flex-col md:flex-row">
      <div className="p-4 border-b-2 md:border-r-2 md:min-h-screen bg-white mt-4 mb-4 rounded-lg">
        <form onSubmit={handleSubmit} className="flex flex-col gap-8">
          ...
          <button className="bg-customBlue text-white p-3 rounded-lg uppercase hover:opacity-85">
            Search
          </button>
        </form>
      </div>
      <div className="flex-1">
        ...
        <div className='p-7 flex flex-wrap gap-4'>
          {!loading && listings.length === 0 && (
            <p className='text-xl text-red-500'>Sorry no such listing found!</p>
          )}
          {loading && (
          ...
          {showMore && (
            <button
              ...
              className='text-customBlue hover:underline p-7 text-center w-full'
            >
              Show more
            </button>
          )}
